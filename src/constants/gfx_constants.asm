...
DEF ICON_TILE_GRASS           EQU $d0
DEF ICON_TILE_FIRE            EQU $d4
DEF ICON_TILE_WATER           EQU $d8
DEF ICON_TILE_LIGHTNING       EQU $dc
DEF ICON_TILE_PSYCHIC         EQU $e0
DEF ICON_TILE_FIGHTING        EQU $e4
DEF ICON_TILE_DARKNESS        EQU $e8
DEF ICON_TILE_METAL           EQU $ec
DEF ICON_TILE_DRAGON          EQU $f0
